...
describe('dataReducer', () => {
  ...
  it('should set offers on fetchOffers.fulfilled', () => {
    ...
    const result = dataReducer(initialState, fetchOffers.fulfilled(offers, '', undefined));
  ...
  it('should set currentOffer on fetchOffer.fulfilled', () => {
    ...
    const result = dataReducer(initialState, fetchOffer.fulfilled(offer, '', ''));
  ...
  it('should set nearbyOffers on fetchNearbyOffers.fulfilled', () => {
    ...
    const result = dataReducer(initialState, fetchNearbyOffers.fulfilled(nearby, '', ''));
  ...
  it('should set reviews on fetchReviews.fulfilled', () => {
    ...
    const result = dataReducer(initialState, fetchReviews.fulfilled(reviews, '', ''));
  ...
  it('should set favoriteOffers on fetchFavorites.fulfilled', () => {
    ...
    const result = dataReducer(initialState, fetchFavorites.fulfilled(favorites, '', undefined));
  ...
  it('should add offer to favoriteOffers when isFavorite becomes true', () => {
    ...
    const state = {...initialState, offers: [offer]};
    const result = dataReducer(state, toggleFavorite.fulfilled(offer, '', {offerId: offer.id, status: 1}));
  ...
  it('should remove offer from favoriteOffers when isFavorite becomes false', () => {
    ...
    const result = dataReducer(state, toggleFavorite.fulfilled(offer, '', {offerId: offer.id, status: 0}));
