...
const makeStore = (favorites: Offer[] = [], userData: AuthInfo | null = null, authorizationStatus = AuthorizationStatus.Auth) =>
  configureStore({
    reducer: rootReducer,
    preloadedState: {
      [NameSpace.App]: {city: 'Paris', isOffersLoading: false, isOfferLoading: false},
      [NameSpace.Data]: {offers: [], favoriteOffers: favorites, currentOffer: null, nearbyOffers: [], reviews: []},
...
const renderFavoritesPage = (favorites: Offer[] = [], userData: AuthInfo | null = null) =>
  render(
...
describe('FavoritesPage', () => {
  ...
  it('should group offers by city', () => {
    const offer1 = {...makeMockOffer(), city: {name: 'Paris', location: {latitude: 48.85, longitude: 2.35, zoom: 12}}};
    const offer2 = {...makeMockOffer(), city: {name: 'Amsterdam', location: {latitude: 52.38, longitude: 4.9, zoom: 12}}};
